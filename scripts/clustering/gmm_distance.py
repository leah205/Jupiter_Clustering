...
def run_js_dist(subdir, keywords, param_ranges, 
                           latRng = [85, 95], lngRng = [230, 330], cluster_rng = [2, 12],
                            cm_num = 1):
    ...
    fig.savefig(f"cluster_evaluations/{subdir}/js_plot_{keyword_str}")
