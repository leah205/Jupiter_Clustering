...
def output_cluster_map_and_plot(date, keywords, param_ranges, n_comp = 5, cov_type = "full", 
    ...
    MP.create_cluster_map(date, n_comp, pred, input_arr, subset_shape, sil_score, latRng, lngRng)
    PL.create_cluster_plot(date, keywords, input_arr, pred, sil_score, n_comp, cov_type, latRng, lngRng, cm_num)
